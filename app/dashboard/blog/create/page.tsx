...
export default function BlogForm() {
  ...
  return (
    <Form {...form}>
      ...
      >
        <div className="p-5 gap-5 flex border-b items-center flex-wrap justify-between">
          <div className="flex gap-5 items-center flex-wrap">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <div className="flex items-center gap-1 border bg-zinc-700 rounded-md p-2">
                      <StarIcon />
                      <span>Premium</span>
                      <Switch
                        checked={field.value}
              ...
              <FormControl>
                ...
                >
                  ...
                  <div
                    className={cn(
                      "lg:px-10",
                      isPreview ? "mx-auto w-full" : "w-1/2 lg:block hidden"
                    )}
                  >
